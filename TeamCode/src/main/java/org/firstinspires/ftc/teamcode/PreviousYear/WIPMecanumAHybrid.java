...
@TeleOp(name="WIP Mecanum Hybrid A", group="WIP")

@Disabled
public class WIPMecanumAHybrid extends OpMode implements SensorEventListener{
    ...
    public void loop() {
        ...
        leftTurn=gamepad1.left_stick_x;
        rightTurn=-gamepad1.left_stick_x;
